...
export const events: EventData[] = [
  {
    ...
    videoUrl: "https://www.youtube.com/embed/QTPSSerVZsc",
    isLive: true,
    liveStreamUrl: "https://www.youtube.com/embed/QTPSSerVZsc",
    brochureUrl: "#",
    result: "5,000+ attendees, 98% satisfaction rate",
    speakers: [
      { name: "James Anderson", role: "Keynote Speaker", bio: "CEO of TechVision Inc. with 20+ years in AI and machine learning.", image: team1, linkedin: "https://linkedin.com", twitter: "https://twitter.com" },
      { name: "Sarah Mitchell", role: "Panel Speaker", bio: "VP of Innovation at Global Systems. Expert in digital transformation.", image: team2, linkedin: "https://linkedin.com" },
      { name: "David Chen", role: "Workshop Lead", bio: "CTO at CloudScale. Pioneer in cloud-native architecture.", image: team3, linkedin: "https://linkedin.com", twitter: "https://twitter.com" },
      { name: "Fatima Al-Rashid", role: "AI & Ethics Speaker", bio: "Director of AI Ethics at FutureMinds. Advocate for responsible AI.", image: team4, linkedin: "https://linkedin.com" },
      { name: "Michael Torres", role: "DevOps Speaker", bio: "VP Engineering at ScaleOps. Expert in CI/CD and infrastructure.", image: team5, linkedin: "https://linkedin.com", twitter: "https://twitter.com" },
      { name: "Aisha Karim", role: "Data Science Lead", bio: "Head of Data Science at Analytix. Specializing in predictive models.", image: team6, linkedin: "https://linkedin.com" },
    ],
    chairpersons: [
      { name: "Dr. Hassan Al-Farooq", role: "Conference Chair", bio: "Chairman of the UAE Technology Council. Leading the conference program.", image: speakerChair1, linkedin: "https://linkedin.com" },
      { name: "Prof. Richard Müller", role: "Academic Chair", bio: "Dean of Computer Science at ETH Zurich. Renowned AI researcher.", image: speakerChair2, linkedin: "https://linkedin.com" },
      { name: "Elena Voronova", role: "Industry Chair", bio: "CEO of NovaTech Group. 25+ years in enterprise technology.", image: speakerChair3, linkedin: "https://linkedin.com" },
    ],
    schedule: [
      {
        label: "Day 1",
  ...
  },
  {
    ...
    speakers: [
      { name: "Sarah Mitchell", role: "Opening Speaker", bio: "VP of Innovation at Global Systems. Expert in international trade.", image: team2, linkedin: "https://linkedin.com" },
      { name: "David Chen", role: "Tech Pavilion Lead", bio: "CTO at CloudScale. Showcasing next-gen trade technologies.", image: team3, linkedin: "https://linkedin.com" },
      { name: "Rania El-Sayed", role: "Trade Policy Expert", bio: "Senior Advisor at World Trade Organization.", image: team4, linkedin: "https://linkedin.com" },
      { name: "Marcus Wright", role: "Logistics Speaker", bio: "COO of GlobalFreight. Supply chain optimization expert.", image: team5, linkedin: "https://linkedin.com" },
    ],
    chairpersons: [
      { name: "Dr. Hassan Al-Farooq", role: "Expo Director", bio: "Chairman of the UAE Technology Council. Overseeing exhibition operations.", image: speakerChair1, linkedin: "https://linkedin.com" },
      { name: "Prof. Richard Müller", role: "Trade Forum Chair", bio: "Dean of Economics at ETH Zurich.", image: speakerChair2, linkedin: "https://linkedin.com" },
      { name: "Elena Voronova", role: "Innovation Chair", bio: "CEO of NovaTech Group.", image: speakerChair3, linkedin: "https://linkedin.com" },
    ],
    schedule: [
      {
        label: "Day 1",
  ...
  },
  {
    ...
    speakers: [
      { name: "Dr. Amina Al-Farsi", role: "Keynote Speaker", bio: "Chief Medical Officer at MedTech Global.", image: team4, linkedin: "https://linkedin.com" },
      { name: "James Anderson", role: "HealthTech Lead", bio: "CEO of TechVision Inc. Digital health solutions.", image: team1, linkedin: "https://linkedin.com" },
      { name: "Sarah Mitchell", role: "Panel Moderator", bio: "VP of Innovation. Healthcare transformation expert.", image: team2, linkedin: "https://linkedin.com" },
      { name: "David Chen", role: "Tech Workshop Lead", bio: "CTO at CloudScale. Health data architecture.", image: team3, linkedin: "https://linkedin.com" },
    ],
    chairpersons: [
      { name: "Dr. Hassan Al-Farooq", role: "Forum Chair", bio: "Leading the healthcare forum.", image: speakerChair1, linkedin: "https://linkedin.com" },
      { name: "Elena Voronova", role: "Innovation Chair", bio: "CEO of NovaTech Group.", image: speakerChair3, linkedin: "https://linkedin.com" },
      { name: "Prof. Richard Müller", role: "Research Chair", bio: "Dean of Medical Sciences.", image: speakerChair2, linkedin: "https://linkedin.com" },
    ],
    schedule: [
  ...
  },
  {
    ...
    speakers: [
      { name: "David Chen", role: "Panel Moderator", bio: "CTO at CloudScale. Fintech innovation expert.", image: team3, linkedin: "https://linkedin.com" },
      { name: "Sarah Mitchell", role: "Keynote Speaker", bio: "VP of Innovation. Digital banking expert.", image: team2, linkedin: "https://linkedin.com" },
      { name: "Michael Torres", role: "Blockchain Speaker", bio: "VP Engineering at ScaleOps. DeFi specialist.", image: team5, linkedin: "https://linkedin.com" },
      { name: "Aisha Karim", role: "RegTech Lead", bio: "Head of Data Science. Compliance analytics.", image: team6, linkedin: "https://linkedin.com" },
      { name: "Tariq Bashir", role: "PayTech Speaker", bio: "Technical Director. Payment systems expert.", image: team7, linkedin: "https://linkedin.com" },
    ],
    chairpersons: [
      { name: "Dr. Hassan Al-Farooq", role: "Summit Chair", bio: "Chairman of the UAE Technology Council.", image: speakerChair1, linkedin: "https://linkedin.com" },
      { name: "Prof. Richard Müller", role: "Academic Chair", bio: "Dean of Economics at ETH Zurich.", image: speakerChair2, linkedin: "https://linkedin.com" },
      { name: "Elena Voronova", role: "Industry Chair", bio: "CEO of NovaTech Group.", image: speakerChair3, linkedin: "https://linkedin.com" },
    ],
    schedule: [
